...
public class HappyNumbers {
	...
	2. Check the condition whether the given number is greater than 0
		...
		the loop iterartes take remainder(n%10) and quotient(n/10) still it the given number reaches 
	3. Each iteration check wheather n reaches 0
		...
		Eg:--> 2(is not a happy number because when calculate the happy number as follows
				2,4,16,37,58,89,145,42,20,4-->it start with 4 again it reachiing the 4
